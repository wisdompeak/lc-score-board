...
count0 = 0
count = 0
for x in PeopleStatOut0:
  if x >= 365/2 : count0+=1
for x in PeopleStatOut:
  if x >= 365/2 : count+=1  
print(count0, len(PeopleStatOut0), count0/len(PeopleStatOut0))
print(count, len(PeopleStatOut), count/len(PeopleStatOut))

plt.figure(11,figsize=(16,8))

maxDay = 365*2
n, bins, patches = plt.hist(x=[PeopleStatOut0,PeopleStatOut], bins=list(range(0,31*25,31)), label = ['by 2020','by 2021'], alpha=0.7, rwidth=0.85)
