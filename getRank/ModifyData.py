...
## before 279
for contest in range(118,278+1): 	
	data["dingmingcheng1"][str(contest)]=[-2,0]
	data["SSSuper"][str(contest)]=[-2,0]
	data["hzhang216"][str(contest)]=[-2,0]
	data["maomao6551675"][str(contest)]=[-2,0]
	data["jiangjinjinyxt"][str(contest)]=[-2,0]
	data["elaine93"][str(contest)]=[-2,0]
	data["Yifei_Chen"][str(contest)]=[-2,0]
	data["jeemzz147"][str(contest)]=[-2,0]
for contest in range(264,278+1): 	
	data["ddoudle"][str(contest)]=[-2,0]
for contest in range(127,278+1): 	
	data["QAMichaelPeng"][str(contest)]=[-2,0]	

## before 280
for contest in range(118,279+1): 	
	data["mengyuan1112"][str(contest)]=[-2,0]
	data["xy-li"][str(contest)]=[-2,0]
	data["wangsc98"][str(contest)]=[-2,0]
	data["lympanda"][str(contest)]=[-2,0]
...
## before 281
for contest in range(118,280+1): 	
	data["awesomexiao123"][str(contest)]=[-2,0]
	data["zhi-zhi"][str(contest)]=[-2,0]
	data["FAANG_LOVER"][str(contest)]=[-2,0]
	data["kingsleycode"][str(contest)]=[-2,0]
	data["sheepforever"][str(contest)]=[-2,0]
for contest in range(217,280+1): 	
	data["X_Chen6"][str(contest)]=[-2,0]

## before 282
for contest in range(118,281+1): 	
	data["maxusun"][str(contest)]=[-2,0]
	data["fake_fan"][str(contest)]=[-2,0]
	data["ivennn"][str(contest)]=[-2,0]

## before 283
for contest in range(118,282+1): 	
	data["YLDJW"][str(contest)]=[-2,0]
	data["chintsai"][str(contest)]=[-2,0]
	data["s192516"][str(contest)]=[-2,0]
for contest in range(246,282+1): 	
	data["HarrisonShen"][str(contest)]=[-2,0]

## before 284
for contest in range(118,283+1): 	
	data["silencea"][str(contest)]=[-2,0]
	data["yeziyqf"][str(contest)]=[-2,0]
	data["ye92"][str(contest)]=[-2,0]
	data["AxelTchaikovsky"][str(contest)]=[-2,0]
for contest in range(279,283+1): 	
	data["PurplePearl"][str(contest)]=[-2,0]

## before 285
for contest in range(118,284+1): 	
	data["annoyingpatrick"][str(contest)]=[-2,0]
	data["kpole"][str(contest)]=[-2,0]
	data["wyz565169669"][str(contest)]=[-2,0]
	data["yqmmm"][str(contest)]=[-2,0]
	data["kirasj"][str(contest)]=[-2,0]

## before 286
for contest in range(118,285+1): 	
	data["masdc98"][str(contest)]=[-2,0]
	data["zju_might"][str(contest)]=[-2,0]
	data["XiaoXiangFei"][str(contest)]=[-2,0]

## before 287
for contest in range(118,286+1): 	
	data["bakey"][str(contest)]=[-2,0]
	data["WinKKKKy"][str(contest)]=[-2,0]
	data["wbbssr"][str(contest)]=[-2,0]
	data["PeanutPro"][str(contest)]=[-2,0]
	data["AkaBridge"][str(contest)]=[-2,0]
	data["code-devaslife"][str(contest)]=[-2,0]

for contest in range(264,286+1): 	
	data["zhichuan"][str(contest)]=[-2,0]  # rejoin

# data["shsf-fengyu"]=data["stayfoolish2"]
# data.pop("stayfoolish2")
for contest in range(150,286+1): 	
	data["shsf-fengyu"][str(contest)]=[-2,0]  # rejoin

for contest in range(271,286+1): 	
	data["mercerchen"][str(contest)]=[-2,0]  # rejoin

## before 288
for contest in range(118,287+1): 	
	data["sugaruncle1996"][str(contest)]=[-2,0]
	data["gude8997"][str(contest)]=[-2,0]
	data["flagoffer1999"][str(contest)]=[-2,0]
for contest in range(222,287+1): 	
	data["CrhnbP"][str(contest)]=[-2,0]  # rejoin
for contest in range(274,287+1): 	
	data["guyang123"][str(contest)]=[-2,0]  # rejoin
for contest in range(201,287+1): 	
...
for contest in range(118,288+1): 	
	...
	data["_otto"][str(contest)]=[-2,0]
	data["meyi"][str(contest)]=[-2,0]
	data["wssx349"][str(contest)]=[-2,0]
for contest in range(265,288+1): 	
	data["daojingLeetcode"][str(contest)]=[-2,0]  # rejoin
for contest in range(286,288+1): 	
	data["SaveThePlanet"][str(contest)]=[-2,0]  # rejoin

## before 290
for contest in range(118,289+1): 	
	data["AC_Barthes0131"][str(contest)]=[-2,0]
	data["liri0811"][str(contest)]=[-2,0]
for contest in range(279,289+1): 	
	data["Haoyangerrr-MoMo"][str(contest)]=[-2,0]  # rejoin

## before 291
for contest in range(118,290+1): 	
	data["hirokinakamura"][str(contest)]=[-2,0]
	data["damn-glamour"][str(contest)]=[-2,0]
for contest in range(138,290+1): 	
	data["magua-io"][str(contest)]=[-2,0]  # rejoin

## before 292
for contest in range(118,291+1): 	
	data["oli_mbp"][str(contest)]=[-2,0]
	data["vorlorn"][str(contest)]=[-2,0]
	data["Pisces311"][str(contest)]=[-2,0]
for contest in range(250,291+1): 	
	data["lichenz"][str(contest)]=[-2,0]  # rejoin	
for contest in range(275,291+1): 	
...
## before 293
for contest in range(118,292+1): 	
	data["thunderbolts"][str(contest)]=[-2,0]
	data["blahhhhhuwu"][str(contest)]=[-2,0]
for contest in range(291,292+1): 	
	data["ruizhewu"][str(contest)]=[-2,0] # rejoin	

## before 294
for contest in range(118,293+1): 	
	data["littewj"][str(contest)]=[-2,0]
	data["Fzldq"][str(contest)]=[-2,0]
	data["wayjiang"][str(contest)]=[-2,0]
	data["zhuimengren2138"][str(contest)]=[-2,0]
	data["chui"][str(contest)]=[-2,0]
for contest in range(286,293+1): 	
	data["irisbber"][str(contest)]=[-2,0] # rejoin	

## before 295
for contest in range(118,294+1): 	
	data["AAlchemist"][str(contest)]=[-2,0]
for contest in range(138,294+1): 	
	data["sijin"][str(contest)]=[-2,0]

## before 296
for contest in range(118,295+1): 	
	data["fwang"][str(contest)]=[-2,0]
	data["freya-6"][str(contest)]=[-2,0]
	data["ak-bot"][str(contest)]=[-2,0]
	data["terencewongcs"][str(contest)]=[-2,0]
	data["xiaojian9527"][str(contest)]=[-2,0]

## before 297
for contest in range(287,296+1): 	
	data["rookie0080"][str(contest)]=[-2,0] # rejoin	
...
for contest in range(118,297+1): 	
	...
	data["LeaFZ96"][str(contest)]=[-2,0]
for contest in range(290,297+1): 	
...
for contest in range(118,298+1): 	
	data["piangqsq"][str(contest)]=[-2,0]
	data["Peak_2250_MID_in_King-of-Glory"][str(contest)]=[-2,0]
	data["grisyt"][str(contest)]=[-2,0]
...
for contest in range(118,300+1): 	
	...
	data["luyangg"][str(contest)]=[-2,0]
	data["yangxm"][str(contest)]=[-2,0]
for contest in range(286,300+1): 	
	data["Terry95"][str(contest)]=[-2,0] # rejoin
for contest in range(247,300+1): 	
	data["ShangqiYang"][str(contest)]=[-2,0] # rejoin
for contest in range(286,300+1): 	
	data["BestQian"][str(contest)]=[-2,0] # rejoin
...
## before 303
for contest in range(118,302+1): 	
	data["user2001MS"][str(contest)]=[-2,0]
	data["kl649"][str(contest)]=[-2,0]
	data["ManuShi98"][str(contest)]=[-2,0]
for contest in range(236,302+1): 	
	data["blackspinner"][str(contest)]=[-2,0] # rejoin

## before 304
for contest in range(118,303+1): 	
	data["lixia201314"][str(contest)]=[-2,0]
for contest in range(257,303+1): 	
	data["wangyxwyx"][str(contest)]=[-2,0] # rejoin
for contest in range(271,303+1): 	
	data["LeeShengkai"][str(contest)]=[-2,0] # rejoin
for contest in range(279,303+1): 	
	data["ainoyume"][str(contest)]=[-2,0] # rejoin
for contest in range(296,303+1): 	
	data["ZeRoLJ42"][str(contest)]=[-2,0] # rejoin

## before 305
for contest in range(118,304+1): 	
	data["ch365"][str(contest)]=[-2,0]
	data["CarlosTian"][str(contest)]=[-2,0]
for contest in range(284,303+1): 	
	data["shiyaow"][str(contest)]=[-2,0] # rejoin
for contest in range(302,303+1): 	
	data["kingsleycode"][str(contest)]=[-2,0] # rejoin
for contest in range(279,303+1): 	
	data["sjyang_"][str(contest)]=[-2,0] # rejoin

## before 306
for contest in range(118,305+1): 	
	data["fuuuuujc"][str(contest)]=[-2,0]
...
## before 309
for contest in range(118,308+1): 	
	data["lukeiscoding"][str(contest)]=[-2,0]
	data["dj3013158"][str(contest)]=[-2,0]
	data["yx1215"][str(contest)]=[-2,0]
	data["testimony2014"][str(contest)]=[-2,0]
for contest in range(299,308+1): 	
	data["981377660LMT"][str(contest)]=[-2,0] # rejoin

## before 310
for contest in range(118,309+1): 	
	data["nyhneil"][str(contest)]=[-2,0]
	data["zjuturtle"][str(contest)]=[-2,0]
...
## before 313	
for contest in range(118,312+1): 	
	data["bangbangwo"][str(contest)]=[-2,0]
	data["uilnauyis_DP"][str(contest)]=[-2,0]
	data["baibest1"][str(contest)]=[-2,0]
for contest in range(304,312+1): 	
	data["sugaruncle1996"][str(contest)]=[-2,0] # rejoin
for contest in range(288,312+1): 	
	data["deepli"][str(contest)]=[-2,0] # rejoin

data['baibest1']['313'] = [11920, 2]
...
## before 317	
for contest in range(118,316+1): 	
	data["lei-feng-lfss"][str(contest)]=[-2,0]
	data["billhehe"][str(contest)]=[-2,0]
	data["clairehe10"][str(contest)]=[-2,0]
	data["qinzhe"][str(contest)]=[-2,0]
for contest in range(316,316+1): 	
	data["Kaiyu-Wang"][str(contest)]=[-2,0] # rejoin

## before 318	
for contest in range(118,317+1): 	
	data["cqfu728"][str(contest)]=[-2,0]
	data["ggbobo"][str(contest)]=[-2,0]
	data["shannonl"][str(contest)]=[-2,0]
	data["user2550l"][str(contest)]=[-2,0]
for contest in range(282,317+1): 	
	data["wfnuser"][str(contest)]=[-2,0] # rejoin	

## before 319	
for contest in range(316,318+1): 	
	data["LeeShengkai"][str(contest)]=[-2,0] # rejoin	
for contest in range(293,318+1): 	
	data["aChris"][str(contest)]=[-2,0] # rejoin	
for contest in range(248,318+1): 	
	data["lwh14710"][str(contest)]=[-2,0] # rejoin	
for contest in range(151,318+1): 	
	data["song30"][str(contest)]=[-2,0] # rejoin	
for contest in range(200,318+1): 	
...
for contest in range(303,319+1): 	
...
# before 330
for contest in range(118,329+1): 	
	data["shuohe"][str(contest)]=[-2,0]
	data["Kode4Fun"][str(contest)]=[-2,0]
	data["mikeac"][str(contest)]=[-2,0]
for contest in range(315,329+1): 	
...
for contest in range(118,334+1): 	
	data["potatoY"][str(contest)]=[-2,0]
for contest in range(317,334+1): 	
...
# before 338
for contest in range(118,337+1): 	
	data["lwy202898"][str(contest)]=[-2,0] # rejoin

# before 340
for contest in range(118,339+1): 	
	data["atom-w94l9"][str(contest)]=[-2,0] # rejoin

# before 341
for contest in range(297,340+1): 	
	data["SaveThePlanet"][str(contest)]=[-2,0] # rejoin
 
# before 342
for contest in range(118,341+1): 	
	data["wawawamei"][str(contest)]=[-2,0]
	data["sunsq"][str(contest)]=[-2,0]
	data["luckyboylxc"][str(contest)]=[-2,0]
for contest in range(341,341+1): 	
	data["jeemzz147"][str(contest)]=[-2,0] # rejoin
for contest in range(337,341+1): 	
	data["BestQian"][str(contest)]=[-2,0] # rejoin


# before 343
for contest in range(118,342+1): 	
	data["abawlau"][str(contest)]=[-2,0]
	data["tao_mi"][str(contest)]=[-2,0]
 
# before 344
for contest in range(336,343+1): 	
	data["hjx2016"][str(contest)]=[-2,0] # rejoin

# before 345
for contest in range(118,344+1): 	
	data["AulySun"][str(contest)]=[-2,0]

# before 346
for contest in range(343,345+1): 	
	data["user2001MS"][str(contest)]=[-2,0] # rejoin
 

# before 347
for contest in range(118,346+1): 	
	data["feibonaqixu"][str(contest)]=[-2,0]
...
for contest in range(118,349+1): 	
    data["PEIZIJIAN001"][str(contest)]=[-2,0]
for contest in range(338,349+1): 	
	data["Oyyko"][str(contest)]=[-2,0] # rejoin
...
# before 352
for contest in range(118,351+1): 	
    data["user1679lR"][str(contest)]=[-2,0]
for contest in range(314,351+1): 	
	data["zeningc"][str(contest)]=[-2,0] # rejoin	

# before 353
for contest in range(118,352+1): 	
    data["OneMore14"][str(contest)]=[-2,0]
    data["btcmoon"][str(contest)]=[-2,0]
    
# before 355
for contest in range(118,354+1): 	
    data["ivanc-e"][str(contest)]=[-2,0]
    data["Johnsonxiong"][str(contest)]=[-2,0]	
...
# before 361
for contest in range(118,360+1): 	
    data["maggie_ruimin_zhao"][str(contest)]=[-2,0]
    data["BettyLiang"][str(contest)]=[-2,0]
for contest in range(339,360+1): 	
    data["user5807Wf"][str(contest)]=[-2,0]    # rejoin	       
for contest in range(351,360+1): 	
    data["billhehe"][str(contest)]=[-2,0]    # rejoin	   

# before 362
for contest in range(118,361+1): 	
    data["a397704290"][str(contest)]=[-2,0]
    data["haz027"][str(contest)]=[-2,0]
    data["yuuinlc"][str(contest)]=[-2,0]
    data["gavinangelo"][str(contest)]=[-2,0]

data["haz027"]["362"]=[17723,1]

# before 363
for contest in range(334,362+1): 	
    data["ManuShi98"][str(contest)]=[-2,0]    # rejoin	   
for contest in range(351,362+1): 	
    data["Oyyko"][str(contest)]=[-2,0]    # rejoin	 
...
# before 373
for contest in range(118,372+1): 	
...
# before 378
for contest in range(118,377+1): 	
    data["qiye_tan"][str(contest)]=[-2,0] 
...
# before 382
for contest in range(319,381+1): 	
    data["dickbomb"][str(contest)]=[-2,0] 	# rejoin	
for contest in range(371,381+1): 	
    data["mike1234421"][str(contest)]=[-2,0] 	# rejoin		
for contest in range(338,381+1): 	
    data["WKelvinson"][str(contest)]=[-2,0] 	# rejoin		
for contest in range(276,381+1): 	
...
for contest in range(364,382+1): 	
    data["feibonaqixu"][str(contest)]=[-2,0] 	# rejoin	
...
# before 391
for contest in range(379,390+1): 	
    data["Yao_Yin"][str(contest)]=[-2,0] 	# rejoin	
for contest in range(338,390+1): 	
    data["sampleaccountpage"][str(contest)]=[-2,0] 	# rejoin	    

# before 392
for contest in range(118,391+1): 	
    data["isKai"][str(contest)]=[-2,0] 	# rejoin	
...
# before 398
for contest in range(392,397+1): 	
    data["ruizhewu"][str(contest)]=[-2,0] 	# rejoin
for contest in range(333,397+1): 	
    data["ddoudle"][str(contest)]=[-2,0]   # rejoin
for contest in range(394,397+1): 	
    data["xy-li"][str(contest)]=[-2,0] 	# rejoin
for contest in range(118,397+1): 	
    data["Nelson84"][str(contest)]=[-2,0]     

# before 401
for contest in range(118,400+1): 	
    data["kitther"][str(contest)]=[-2,0]

# before 402
for contest in range(118,401+1): 	
    data["HelloKitty_CA"][str(contest)]=[-2,0]
    data["Marvelousp4"][str(contest)]=[-2,0]

# before 403
for contest in range(392,402+1): 	
    data["aniurm35"][str(contest)]=[-2,0]
for contest in range(399,402+1): 	
    data["wangyxwyx"][str(contest)]=[-2,0]
...
# before 414
for contest in range(403,413+1): 	
    data["zyx-37"][str(contest)]=[-2,0]

# before 415
for contest in range(405,414+1): 	
    data["Oyyko"][str(contest)]=[-2,0]
...
# before 419
data['furuyarei'] = data['zerotrac2']
data['ceaxyz002'] = data['ceaxyz']
data.pop('ceaxyz')
...
# before 422
for contest in range(118,421+1): 	
    data["lawrencewxy"][str(contest)]=[-2,0]    
    data["liyangzi6p626"][str(contest)]=[-2,0]    


# before 423
for contest in range(118,422+1): 	
    data["lily_shen"][str(contest)]=[-2,0]    
...
# before 428
for contest in range(118,427+1): 	
    data["chao24"][str(contest)]=[-2,0]        
...
for contest in range(321,430+1): 	
    data["sugaruncle1996"][str(contest)]=[-2,0]
for contest in range(338,430+1): 	
    data["htkzmo"][str(contest)]=[-2,0]
...
# before 440
for contest in range(118,439+1): 	
...
# before 446
for contest in range(118,445+1): 	
...
#before 466
for contest in range(118,465+1): 	
...
#before 469
for contest in range(118,468+1): 	
    data["ligjerry007"][str(contest)]=[-2,0]  
...
for contest in range(118,480+1): 	
	data["applebeeble"][str(contest)]=[-2,0]  
...
# data["ottffyzy"] = data["OTTFF"]
# data.pop("OTTFF")
data["ottffyzy"]["490"]=[15639,2]
